...
//
// СТРУКТУРА:
//   Маршрут_Цюріх/Женева/Запасний  — пасажири + посилки (поле "Тип запису")
//   Відправка_Цюріх/Женева/Запасний — відправлення (read-only для водія)
//   Витрати_Цюріх/Женева/Запасний  — витрати водія
...
var KNOWN_ROUTES = ['Маршрут_Цюріх', 'Маршрут_Женева', 'Маршрут_Запасний'];
var KNOWN_SHIPPING = [
