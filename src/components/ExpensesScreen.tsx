...
import { fetchExpenses, addExpense, deleteExpense, updateAdvance, buildRouteSummaryApi } from '../api';
...
export function ExpensesScreen() {
  ...
  const handleBuildSummary = async () => {
    ...
    try {
      const summary = await buildRouteSummaryApi(currentSheet, driverName);
